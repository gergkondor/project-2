...
(1, 'Robert', 'Smith', '', 'rheffron0@ibm.com', 1),
...
(23, 'Tamarraa', 'Ace', 'Secretary', 'tamara@email.com', 6),
(24, 'Barbara-anne', 'Rooksby', '', 'brooksbyn@issuu.com', 12),
(25, 'Lucien', 'Allsup', 'Cleaner ', 'lallsupo@goo.ne.jp', 1),
...
--
ALTER TABLE `department`
  ADD CONSTRAINT `department_ibfk_1` FOREIGN KEY (`locationID`) REFERENCES `location` (`id`);

--
-- Constraints for table `personnel`
--
ALTER TABLE `personnel`
  ADD CONSTRAINT `personnel_ibfk_1` FOREIGN KEY (`departmentID`) REFERENCES `department` (`id`);
COMMIT;
