				...
				<div class="modal-body">
					<div class="container-fluid">
						...
						<div class="row">
							...
							<div class="col-lg-9">
								<input type="text" name="jobtitle" class="form-control" value="<?php echo $row['jobTitle']; ?>" required>
							</div>
						</div>
						<div style="height:10px;"></div>
						<div class="row">
							...
							<div class="col-lg-9">
								<select name="departmentID" id="selectLocation" class="form-control" required> 
									<?php
										$query = 'SELECT  id,
																			name as dep
																FROM department';
